...
use app\modules\websetting\models\search\WebConfigGroupSearch;
...
/**
 * WebConfigGroupController implements the CRUD actions for WebConfigGroup model.
 **/
class WebConfigGroupController extends \app\components\productive\DefaultActiveController
{
    ...
    /**
    * Lists all WebConfigGroup models.
    * @return mixed
    */
    public function actionIndex()
    {
        $searchModel  = new WebConfigGroupSearch;
    ...
    /**
    * Creates a new WebConfigGroup model.
    ...
    */
    ...
    /**
    * Finds the WebConfigGroup model based on its primary key value.
    * If the model is not found, a 404 HTTP exception will be thrown.
    * @param integer $id
    * @return WebConfigGroup the loaded model
    * @throws HttpException if the model cannot be found
    */
    protected function findModel($id)
    {
        if (($model = WebConfigGroup::findOne($id)) !== null) {
            return $model;
        } else {
