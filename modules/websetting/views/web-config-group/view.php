...
$this->title = 'Web Config Group : ' . $model->name;
?>
<div class="giiant-crud web-config-group-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="fa fa-list"></span> ' . Yii::t('cruds', 'Daftar Web Config Group'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    <?php endif ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                <?php endif ?>
                    <?php $this->beginBlock('app\modules\websetting\models\WebConfigGroup'); ?>
            ...
            'format' => 'text',
                    ...
                    [
                        ...
                        'content' => $this->blocks['app\modules\websetting\models\WebConfigGroup'],
                        'active'  => true,
                    ],
                        ]
                    ]);
