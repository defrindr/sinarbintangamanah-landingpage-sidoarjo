...
use app\models\search\TestimoniSearch;
...
/**
 * ManagementTestimoniController implements the CRUD actions for Testimoni model.
 **/
class ManagementTestimoniController extends \app\components\productive\DefaultActiveController
{
    ...
    public function __construct($id, $module, $config = [])
    {
        ...
        // $this->validation = new \app\validations\TestimoniValidation();
    }
