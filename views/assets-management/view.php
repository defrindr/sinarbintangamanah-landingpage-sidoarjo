...
$this->title = Yii::t('cruds', 'Assets') . ' : ' . $model->id;
?>
<div class="giiant-crud assets-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="fa fa-list"></span> ' . Yii::t('cruds', 'Daftar Assets'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    <?php endif ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                <?php endif ?>
                    <?php $this->beginBlock('app\models\Assets'); ?>
            ...
            'format' => 'text',
                    ...
                    [
                        ...
                        'content' => $this->blocks['app\models\Assets'],
                        'active'  => true,
                    ],
                        ]
                    ]);
