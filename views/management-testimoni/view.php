...
$this->title = Yii::t('cruds', 'Testimoni') . ' : ' . $model->name;
?>
<div class="giiant-crud testimoni-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="fa fa-list"></span> ' . Yii::t('cruds', 'Daftar Testimoni'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    <?php endif ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                <?php endif ?>
                    <?php $this->beginBlock('app\models\Testimoni'); ?>
            ...
            'format' => 'iddate',
                    ...
                    [
                        ...
                        'content' => $this->blocks['app\models\Testimoni'],
                        'active'  => true,
                    ],
                        ]
                    ]);
